...
<head>
	...
	$(document).ready(function(){
	    ...
	    setInterval(function(){
			var timequery = '<?php echo URL::route('timequery') ?>';
		    $('#servertime').load(timequery).fadeIn("slow");
		},1000);
	});
	</script>
	...
	<script type="text/javascript" src="{{@Config::get('app.url')}}/template/assets/js/demo/pages_calendar.js"></script>
	<script type="text/javascript" src="{{@Config::get('app.url')}}/template/assets/js/demo/charts/chart_filled_blue.js"></script>
	<script type="text/javascript" src="{{@Config::get('app.url')}}/template/assets/js/demo/charts/chart_simple.js"></script>
</head>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown user">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						<i class="icon-male"></i>
						<span class="username"><?php echo session('userid');?></span>
			...
			<div class="container">
				...
				<div class="crumbs">
					...
					<ul class="crumb-buttons">
						...
						<li><a href="#" title=""><i class="far fa-clock"></i><span id="servertime"></span></a></li>
					</ul>
				</div>
				<!-- /Breadcrumbs line -->
