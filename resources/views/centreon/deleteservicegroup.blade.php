	...
	<div class="col-md-12">
		<div class="widget box">
			<div class="widget-header">
				<h4><i class="icon-trash"></i> Delete service group</h4>&nbsp;&nbsp;
      ...
      <div id="err_msg" style="display: none;">{{$err_msg}}</div>
        ...
        <form class="form-horizontal row-border" action="{{@Config::get('app.url')}}/admin/centreon/srvgroup/delete/{{$name}}" method="POST">
          @csrf
