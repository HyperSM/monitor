                            ...
                            <div class="widget-content" id="summaryinfo">
                                <table width="100%" >
                                    <body>
                                        ...
                                        <tr>
                                            <td colspan="3" style="border-right: 5px solid white;"><input type="text" name="summary"  class="form-control" value='{{$tmpstr["Summary"]}}' required></td>
                                        </tr>
                                        <tr style="background-color: #D0D5D8;">
                                            <td colspan="3"><b>Description</b></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="border-right: 5px solid white;"><input type="text" name="description"  class="form-control" value='{{$tmpstr["Description"]}}' required></td>
                                        </tr>
                                        <tr style="background-color: #D0D5D8;">
                                            <td style="border-right: 5px solid white;"><b>Open Date/Time</b></td>
                                            <td style="border-right: 5px solid white;"><b>Resolve Date/Time</b></td>
                                            <td><b>Close Date/Time</b></td>
                                        </tr>
                                        <tr>
{{--                                            <td style="border-right: 5px solid white;"><input type="text" name="summary" id="summary" class="form-control" value='{{$tmpstr["Open Date"]}}' required></td>--}}
{{--                                            <td style="border-right: 5px solid white;"><input type="text" name="summary" id="summary" class="form-control" value='{{$tmpstr["Resolve Date"]}}' required></td>--}}
{{--                                            <td style="border-right: 5px solid white;"><input type="text" name="summary" id="summary" class="form-control" value='{{$tmpstr["Closed Date"]}}' required></td>--}}
                                        </tr>
                                    </body>
                                </table>
                            </div>
