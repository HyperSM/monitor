...
<h4> <b> <a href="{{@Config::get('app.url')}}/sysadmin/domains">DOMAINS</a> | <a href="{{@Config::get('app.url')}}/sysadmin/domains/{{$domainid}}/users">DOMAIN USERS</a> | EDIT USER </b> </h4>
  ...
  <div class="col-md-12">
    ...
    <div class="widget box">
      ...
      <div class="widget-content">
        <form class="form-horizontal row-border" action="{{@Config::get('app.url')}}/sysadmin/domains/{{$domainid}}/users/edit/{{$selecteduser->userid}}" method="POST">
          @csrf
