...
<h4> <b> <a href="{{@Config::get('app.url')}}/sysadmin/billing/prices">PRICE MANAGEMENT</a> | DELETE PRODUCT PRICE </b> </h4>
<div style="height: 10px;"></div>
<div class="row">
	<div class="col-md-12">
		<div class="widget box">
			<div class="widget-header">
				<h4><i class="icon-trash"></i> Delete price</h4>&nbsp;&nbsp;
      ...
      <div id="err_msg" style="display: none;">{{$err_msg}}</div>
        ...
        <form class="form-horizontal row-border" action="{{@Config::get('app.url')}}/sysadmin/billing/prices/delete/{{$selectedprice->product}}" method="POST">
          ...
          <div class="form-group">
            ...
            <div class="col-md-2"><input type="text" name="productname" class="form-control" placeholder="Type the product name" required></div>
          </div>
